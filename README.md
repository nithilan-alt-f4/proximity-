...
Visit the [releases page](https://github.com/nithilan42/proximity-plus/releases) or the [download page](https://nithilan42.github.io/proximity-plus/).
...
- **Identification**: Groq (`llama-3.1-8b-instant`) resolves filenames → title/artist/album, with user-confirmed values as ground truth
